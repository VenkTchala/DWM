...
//};
#include "/home/siva/.cache/wal/colors-wal-dwm.h"
/* tagging */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-g" , "1" , "-l" , "10" , "-hp" , "opera,emacs,firefox,google-chrome-stable,qutebrowser,kdenlive,postman", NULL };
